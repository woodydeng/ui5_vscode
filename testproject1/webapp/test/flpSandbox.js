		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Test UI5 app",
									"targetURL": "#testproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"testproject1-display": {
								"semanticObject": "testproject1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=testproject1",
									"url": sap.ui.require.toUrl("testproject1")
								}
							}
						}
					}
